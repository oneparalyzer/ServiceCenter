    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SparesOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SparesOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SparesOrders_Spares_SpareId",
                        column: x => x.SpareId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Spares_Title",
                table: "Spares",
                column: "Title",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SparesOrders_OrderId",
                table: "SparesOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SparesOrders_SpareId",
                table: "SparesOrders",
                column: "SpareId");
